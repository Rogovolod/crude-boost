    ...
    function updateUsers() {
        ...
        api.getUsers(function (users) {
            ...
            $('.editBtn').click(function () {
                ...
                editModal.find('#userSalary').val(tdArray[3].innerText);
                editModal.find('#userDepartment').val(tdArray[4].innerText);
                editModal.find('#userLogin').val(tdArray[5].innerText);
                editModal.find('#userPassword').val(tdArray[6].innerText);
                var userRoles = tdArray[7].innerText.split(", ");
            ...
            $('.deleteBtn').click(function () {
                ...
                deleteModal.find('#salaryDelete').val(tdArray[3].innerText);
                deleteModal.find('#departmentDelete').val(tdArray[4].innerText);
                deleteModal.find('#lodinDelete').val(tdArray[5].innerText);
                deleteModal.find('#userPasswordDelete').val(tdArray[6].innerText).hide();
                var userRoles = tdArray[7].innerText.split(", ");
